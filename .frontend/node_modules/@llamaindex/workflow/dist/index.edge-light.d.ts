...
] = [AnyWorkflowEventConstructor | StartEventConstructor], Out extends [
    AnyWorkflowEventConstructor | StartEventConstructor,
    ...(AnyWorkflowEventConstructor | StopEventConstructor)[]
] = [AnyWorkflowEventConstructor | StopEventConstructor]> = (context: HandlerContext<Data>, ...events: {
...
declare class Workflow<ContextData, Start, Stop> {
    ...
    addStep<const In extends [
        ...
        AnyWorkflowEventConstructor | StopEventConstructor,
        ...(AnyWorkflowEventConstructor | StopEventConstructor)[]
    ]>(parameters: StepParameters<In, Out>, stepFn: (context: HandlerContext<ContextData>, ...events: {
