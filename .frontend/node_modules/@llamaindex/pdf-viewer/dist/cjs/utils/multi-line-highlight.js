 ...
 */
const multiHighlight = (textToHighlight, pageNumber, color = colors_js_1.DocumentColorEnum.yellow) => {
    var _a;
    const highlightColor = colors_js_1.highlightColors[color];
    ...
    // @ts-ignore
    const fuse = new fuse_js_1.default(searchData, options);
...
exports.multiHighlight = multiHighlight;
